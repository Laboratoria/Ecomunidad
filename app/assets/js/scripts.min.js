...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    _gsScope._gsDefine("TweenMax", [ "core.Animation", "core.SimpleTimeline", "TweenLite" ], function(a, b, c) {
        ...
        e.render = c.render, j.invalidate = function() {
            ...
            this._yoyo && 0 !== (1 & this._cycle) && (this._time = s - this._time), this._time > s ? this._time = s : this._time < 0 && (this._time = 0)), 
            ...
            this.ratio = 1 === l ? 1 - j : 2 === l ? j : this._time / s < .5 ? j / 2 : 1 - j / 2) : this.ratio = this._ease.getRatio(this._time / s)), 
        ...
        q.to = function(a, b, d, e) {
            ...
            f = f || 0, 0 > f && (a = p(a), a.reverse(), f *= -1), l = 0; l < a.length; l++) e.startAt && (e.startAt = n(e.startAt)), 
            m.to(a[l], b, n(e), l * f);
            return this.add(m, g);
            ...
            h = "onComplete", 0 === this._duration && (0 === a || this._rawPrevTime < 0 || this._rawPrevTime === e) && this._rawPrevTime !== a && this._first && (i = !0, 
            ...
            this._time !== n && this._first || c || i) {
                ...
                d = g; else for (d = this._last; d && (g = d._prev, !this._paused || q); ) (d._active || d._startTime <= n && !d._paused && !d._gc) && (d._reversed ? d.render((d._dirty ? d.totalDuration() : d._totalDuration) - (a - d._startTime) * d._timeScale, b, c) : d.render((a - d._startTime) * d._timeScale, b, c)), 
                d = g;
        ...
        return k.constructor = d, k.kill()._gc = !1, d.version = "1.15.1", k.invalidate = function() {
            ...
            d = j; else for (d = this._last; d && (j = d._prev, !this._paused || u); ) (d._active || d._startTime <= p && !d._paused && !d._gc) && (d._reversed ? d.render((d._dirty ? d.totalDuration() : d._totalDuration) - (a - d._startTime) * d._timeScale, b, c) : d.render((a - d._startTime) * d._timeScale, b, c)), 
            d = j;
        ...
        var k, l, m, n, o, p, q = /(?:\d|\-\d|\.\d|\-\.\d)+/g, r = /(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g, s = /(?:\+=|\-=|\-|\b)[\d\-\.]+[a-zA-Z0-9]*(?:%|\b)/gi, t = /(?![+-]?\d*\.?\d+|[+-]|e[+-]\d+)[^0-9]/g, u = /(?:\d|\-|\+|=|#|\.)*/g, v = /opacity *= *([^)]*)/i, w = /opacity:([^;]*)/i, x = /alpha\(opacity *=.+?\)/i, y = /^(rgb|hsl)/, z = /([A-Z])/g, A = /-([a-z])/gi, B = /(^(?:url\(\"|url\())|(?:(\"\))$|\)$)/gi, C = function(a, b) {
            ...
            [ a >> 16, a >> 8 & 255, 255 & a ]) : "hsl" === a.substr(0, 3) ? (a = a.match(q), 
        ...
        var lb = function(a, b, c, d) {
            ...
            l && (l._prev = null, l._prev && (l._prev._next = null))); d && d !== l; ) {
                if (d.type <= 1 && (h = d.p, n[h] = d.s + d.c, m[h] = d.s, f || (j = new nb(d, "s", h, j, d.r), 
            ...
            v && (o = o.length < 4 ? 1 : o[3], g.appendXtra("", o, (p.length < 4 ? 1 : p[3]) - o, z, !1))); else if (s = o.match(q)) {
                if (t = p.match(r), !t || t.length !== s.length) return g;
                for (n = 0, m = 0; m < s.length; m++) x = s[m], w = o.indexOf(x, n), g.appendXtra(o.substr(n, w - n), Number(x), eb(t[m], x), "", D && "px" === o.substr(w + x.length, 2), 0 === m), 
                n = w + x.length;
                g["xs" + g.l] += o.substr(n);
        ...
        var ub, vb = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","), wb = V("transform"), xb = T + "transform", yb = V("transformOrigin"), zb = null !== V("perspective"), Ab = O.Transform = function() {
            ...
            var f, h, i, j, k, l, m, n, o, p, q = c ? a._gsTransform || new Ab() : new Ab(), r = q.scaleX < 0, s = 2e-5, t = 1e5, u = zb ? parseFloat(X(a, yb, b, !1, "0 0 0").split(" ")[2]) || q.zOrigin || 0 : 0, v = parseFloat(g.defaultTransformPerspective) || 0;
            ...
            f = 0)), !f) {
                ...
                i[j] = (l = k - (k |= 0)) ? (l * t + (0 > l ? -.5 : .5) | 0) / t + k : k;
                if (16 === i.length) {
                    ...
                    q.rotationY += 180), q.scaleX = (Math.sqrt(B * B + C * C) * t + .5 | 0) / t, q.scaleY = (Math.sqrt(H * H + M * M) * t + .5 | 0) / t, 
                    q.scaleZ = (Math.sqrt(J * J + N * N) * t + .5 | 0) / t, q.skewX = 0, q.perspective = R ? 1 / (0 > R ? -R : R) : 0, 
                    q.x = O, q.y = P, q.z = Q;
                    ...
                    Math.abs(p) > 90 && Math.abs(p) < 270 && (r ? (m *= -1, p += 0 >= o ? 180 : -180, 
            ...
            l = 1e-6, l > p && p > -l && (p = 0), l > q && q > -l && (q = 0)), k = (g * d | 0) / d + "," + (h * d | 0) / d + "," + (i * d | 0) / d + "," + (j * d | 0) / d + "," + p + "," + q + ")", 
        ...
        j.scaleX = j.scaleY = j.scaleZ = 1, sb("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent", {
            ...
            parser: function(a, b, c, f, g) {
                ...
                i = 0; i < x.length; i++) this.p.indexOf("border") && (x[i] = V(x[i])), l = k = X(a, x[i], e, !1, "0px"), 
                ...
                v = Y(a, "borderTop", n, s), "%" === r ? (l = u / p * 100 + "%", k = v / q * 100 + "%") : "em" === r ? (w = Y(a, "borderLeft", 1, "em"), 
        ...
        j = g.prototype, j._firstPT = j._lastParsedTransform = j._transform = null, j._onInitTween = function(a, b, h) {
            ...
            p = "px"), r && (l || 0 === l) && (n = l + j + p)), r && (l += j), !j && 0 !== j || !l && 0 !== l ? void 0 !== s[g] && (n || n + "" != "NaN" && null != n) ? (c = new ob(s, g, l || j || 0, 0, c, -1, g, !1, 0, m, n), 
        ...
        init: function(a, b) {
            ...
            -1 !== d.indexOf("_cw") && 0 > g ? g = (g + 9999999999 * i) % i - (g / i | 0) * i : -1 !== d.indexOf("ccw") && g > 0 && (g = (g - 9999999999 * i) % i - (g / i | 0) * i)), 
    ...
    if (!c.TweenLite) {
        var d, e, f, g, h, i = function(a) {
            ...
            this.check = function(j) {
                ...
                q = 0; q < this.sc.length; q++) this.sc[q].check();
            }, this.check(!0);
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    $(document).ready(function() {
        ...
        $(".disable-anchors a").click(function(a) {
            ...
            console.log($(a)), console.log(b), $(a).addClass("bg-img-block").css({
                "background-image": "url(" + b + ")"
            });
        }, $.each(a, function(a, e) {
            var f;
            switch (f = $(e).data("responsive-bg-img"), console.log(f), console.log(f["vw-lg-desktop"]), 
            !0) {
